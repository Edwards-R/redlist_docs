# iRecord data evaluation for the Aculeate Hymenoptera Red List <!-- omit in toc -->
...
- [1.1. Introduction](#11-introduction)
  - [1.1.1. Why check data so carefully?](#111-why-check-data-so-carefully)
  - [1.1.2. What is contained](#112-what-is-contained)
  - [1.1.3. Importing iRecord data](#113-importing-irecord-data)
    - [1.1.3.1. Pre-Checker](#1131-pre-checker)
    - [1.1.3.2. Checker pass rate](#1132-checker-pass-rate)
    - [1.1.3.3. Checker failure reason](#1133-checker-failure-reason)
  - [1.1.4. Simple Unique Record](#114-simple-unique-record)
  - [1.1.5. iRecord verification status](#115-irecord-verification-status)
    - [1.1.5.1. Verification status 1](#1151-verification-status-1)
    - [1.1.5.2. Verification status 2](#1152-verification-status-2)
    - [1.1.5.3. Verification status 2 breakdown](#1153-verification-status-2-breakdown)
  - [1.1.6. Threshold for use](#116-threshold-for-use)
    - [1.1.6.1. Correct: simple unique record](#1161-correct-simple-unique-record)
  - [1.1.7. Scheme overlap](#117-scheme-overlap)
    - [1.1.7.1. iRecord and BWARS userbase comparison](#1171-irecord-and-bwars-userbase-comparison)
    - [1.1.7.2. Verification status of overlap](#1172-verification-status-of-overlap)
    - [1.1.7.3. Shortlist of available records](#1173-shortlist-of-available-records)
  - [1.1.8. Taxon grouping](#118-taxon-grouping)
    - [1.1.8.1. Taxon groupings](#1181-taxon-groupings)
    - [1.1.8.2. Absolute record count taxonomic composition](#1182-absolute-record-count-taxonomic-composition)
    - [1.1.8.3. Percentage-based taxonomic composition](#1183-percentage-based-taxonomic-composition)
  - [1.1.9. Identification difficulty](#119-identification-difficulty)
    - [1.1.9.1. Scheme difficulty comparison](#1191-scheme-difficulty-comparison)
  - [1.1.10. Scheme difficulty comparison as 'number of records per group'](#1110-scheme-difficulty-comparison-as-number-of-records-per-group)
    - [1.1.10.1. iRecord difficulty distribution by verification status 2](#11101-irecord-difficulty-distribution-by-verification-status-2)
  - [1.1.11. iRecord Verifiers \& Rules](#1111-irecord-verifiers--rules)
    - [1.1.11.1. iRecord](#11111-irecord)
    - [1.1.11.2. BWARS](#11112-bwars)
    - [1.1.11.3. Custom rules](#11113-custom-rules)
  - [1.1.12. Verification status breakdown](#1112-verification-status-breakdown)
  - [1.1.13. Misapplication of Correct](#1113-misapplication-of-correct)
    - [1.1.13.1. Multi-record processing](#11131-multi-record-processing)
  - [1.1.14. Verification Status 1 vs Verification Status 2](#1114-verification-status-1-vs-verification-status-2)
    - [1.1.14.1. Number of records per year without `verification status 2`](#11141-number-of-records-per-year-without-verification-status-2)
    - [1.1.14.2. Broad taxon composition](#11142-broad-taxon-composition)
  - [1.1.15. Conclusion](#1115-conclusion)
- [1.2. Spatial Range Checking](#12-spatial-range-checking)
  - [1.2.1. Sources of major error](#121-sources-of-major-error)
  - [1.2.2. Breakdown of rejections per Understanding](#122-breakdown-of-rejections-per-understanding)
    - [1.2.2.1. Breakdown of rejections per Understanding, all records](#1221-breakdown-of-rejections-per-understanding-all-records)
    - [1.2.2.2. Breakdown per Understanding, `Correct` only](#1222-breakdown-per-understanding-correct-only)
    - [1.2.2.3. Breakdown per Understanding, `Considered correct` only](#1223-breakdown-per-understanding-considered-correct-only)
  - [1.2.3. Rates of rejection](#123-rates-of-rejection)
  - [1.2.4. Magnitude of rejection](#124-magnitude-of-rejection)
    - [1.2.4.1. Magnitude, correct only](#1241-magnitude-correct-only)
    - [1.2.4.2. Magnitude, considered correct only](#1242-magnitude-considered-correct-only)
    - [1.2.4.3. Spatial magnitude per verification status 2](#1243-spatial-magnitude-per-verification-status-2)
  - [1.2.5. Discussion](#125-discussion)
    - [1.2.5.1. Expansion potential](#1251-expansion-potential)
    - [1.2.5.2. Major sources of rejection](#1252-major-sources-of-rejection)
    - [1.2.5.3. *Bombus hypnorum*](#1253-bombus-hypnorum)
    - [1.2.5.4. *Anthophora plumipes*](#1254-anthophora-plumipes)
    - [1.2.5.5. Lack of general theme](#1255-lack-of-general-theme)
    - [1.2.5.6. 'Correct' vs 'Considered correct'](#1256-correct-vs-considered-correct)
    - [1.2.5.7. Does verification work](#1257-does-verification-work)
    - [1.2.5.8. Magnitude of rejection](#1258-magnitude-of-rejection)
    - [1.2.5.9. Further investigation](#1259-further-investigation)
  - [1.2.6. Conclusion](#126-conclusion)
- [1.3. Temporal Range Checking](#13-temporal-range-checking)
  - [1.3.1. Sources of major error](#131-sources-of-major-error)
  - [1.3.2. Impact of tolerance](#132-impact-of-tolerance)
  - [1.3.3. Breakdown per taxon](#133-breakdown-per-taxon)
    - [1.3.3.1. Breakdown of rejections per Understanding, all records](#1331-breakdown-of-rejections-per-understanding-all-records)
  - [1.3.4. Breakdown per Understanding, `Correct` only](#134-breakdown-per-understanding-correct-only)
  - [1.3.5. Breakdown per Understanding, `Considered correct` only](#135-breakdown-per-understanding-considered-correct-only)
  - [1.3.6. Rates of rejection](#136-rates-of-rejection)
  - [1.3.7. Discussion](#137-discussion)
    - [1.3.7.1. Human disturbance](#1371-human-disturbance)
    - [1.3.7.2. *Bombus lapidarius*](#1372-bombus-lapidarius)
    - [1.3.7.3. *Bombus pratorum*/*pascuorum*](#1373-bombus-pratorumpascuorum)
    - [1.3.7.4. *Bombus sylvarum*](#1374-bombus-sylvarum)
    - [1.3.7.5. Does verification work?](#1375-does-verification-work)
    - [1.3.7.6. Further investigation](#1376-further-investigation)
  - [1.3.8. Conclusion](#138-conclusion)
- [1.4. Conclusion](#14-conclusion)
  - [1.4.1. Notes](#141-notes)
- [1.5. Glossary of terms for iRecord Data Analysis sub-project](#15-glossary-of-terms-for-irecord-data-analysis-sub-project)
  - [1.5.1. Reviewer](#151-reviewer)
  - [1.5.2. Verifier](#152-verifier)
  - [1.5.3. Determiner](#153-determiner)
  - [1.5.4. Incorrect Correct error](#154-incorrect-correct-error)
  - [1.5.5. Voucher](#155-voucher)


## 1.1. Introduction
### 1.1.1. Why check data so carefully?
...
#### 1.1.3.3. Checker failure reason
...
### 1.1.5. iRecord verification status

#### 1.1.5.1. Verification status 1
...
#### 1.1.5.3. Verification status 2 breakdown
...
#### 1.1.6.1. Correct: simple unique record
...
#### 1.1.7.1. iRecord and BWARS userbase comparison
...
#### 1.1.7.2. Verification status of overlap
...
#### 1.1.7.3. Shortlist of available records
...
#### 1.1.8.2. Absolute record count taxonomic composition
...
#### 1.1.8.3. Percentage-based taxonomic composition
...
### 1.1.9. Identification difficulty
...
#### 1.1.9.1. Scheme difficulty comparison
...
### 1.1.10. Scheme difficulty comparison as 'number of records per group'
...
#### 1.1.10.1. iRecord difficulty distribution by verification status 2
...
### 1.1.11. iRecord Verifiers & Rules
...
### 1.1.12. Verification status breakdown
...
### 1.1.13. Misapplication of Correct
...
#### 1.1.13.1. Multi-record processing
...
### 1.1.14. Verification Status 1 vs Verification Status 2
...
#### 1.1.14.1. Number of records per year without `verification status 2`
...
#### 1.1.14.2. Broad taxon composition
...
### 1.2.2. Breakdown of rejections per Understanding
...
#### 1.2.2.1. Breakdown of rejections per Understanding, all records
...
#### 1.2.2.2. Breakdown per Understanding, `Correct` only
...
#### 1.2.2.3. Breakdown per Understanding, `Considered correct` only
...
#### 1.2.4.1. Magnitude, correct only
...
#### 1.2.4.2. Magnitude, considered correct only
...
#### 1.2.4.3. Spatial magnitude per verification status 2
...
#### 1.2.5.2. Major sources of rejection
...
#### 1.2.5.6. 'Correct' vs 'Considered correct'
...
#### 1.2.5.7. Does verification work
...
#### 1.2.5.8. Magnitude of rejection
...
#### 1.3.3.1. Breakdown of rejections per Understanding, all records
...
### 1.3.4. Breakdown per Understanding, `Correct` only
...
### 1.3.5. Breakdown per Understanding, `Considered correct` only
...
#### 1.3.7.3. *Bombus pratorum*/*pascuorum*
...
#### 1.3.7.5. Does verification work?
...
## 1.5. Glossary of terms for iRecord Data Analysis sub-project
