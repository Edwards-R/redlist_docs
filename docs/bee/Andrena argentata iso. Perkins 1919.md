...
|Attribute|Assessment|Value|Accepted|Justification
|---|---|---|---|---|
|B1 (AoO)|LC|-54.5454545454545455|No|Expert opinion is that the volume of sampling has drastically decreased across the time period. Declines are therefore considered to be a statistical artefact caused by variation in sampling effort|

|B1 (dEoO)|LC|-6.5146652402603192|Yes||

|B2 (AoO)|NT|-54.5454545454545455|No|Expert opinion is that the volume of sampling has drastically decreased across the time period. Declines are therefore considered to be a statistical artefact caused by variation in sampling effort|

|B2 (dEoO)|LC|-6.5146652402603192|Yes||
