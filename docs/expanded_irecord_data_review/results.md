...
## 1. Introduction
This document details the impact of the inclusion of all iRecord `Correct` and `Considered correct` records to the combined BWARS & Essex Field Club (EFC) dataset.
