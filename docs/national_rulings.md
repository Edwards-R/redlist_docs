...
This document contains the rules by which National Rarities may differ from the strict application of the method. Each change has been made to improve the precision of the output.
