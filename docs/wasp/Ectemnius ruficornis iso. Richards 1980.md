...
|Attribute|Assessment|Value|Accepted|Justification
|---|---|---|---|---|
|B1 (AoO)|LC|-40.625|No|AoO changes are not backed by other metrics and have exhibited strong variance, likely due to variance in sampling effort rather than true variance of the taxon.|

|B1 (dEoO)|LC|-8.6102203156886427|Yes||

|B2 (AoO)|NT|-40.625|No|AoO changes are not backed by other metrics and have exhibited strong variance, likely due to variance in sampling effort rather than true variance of the taxon.|

|B2 (dEoO)|LC|-8.6102203156886427|Yes||
